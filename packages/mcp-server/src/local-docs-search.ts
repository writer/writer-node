...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/applications/$APPLICATION_ID \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"inputs\": [\n            {\n              \"id\": \"id\",\n              \"value\": [\n                \"string\"\n              ]\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; inputs: { input_type: 'text' | 'dropdown' | 'file' | 'media'; name: string; required: boolean; description?: string; options?: { list: string[]; } | { file_types: string[]; max_file_size_mb: number; max_files: number; max_word_count: number; upload_types: 'url' | 'file_id'[]; } | { file_types: string[]; max_image_size_mb: number; } | { max_fields: number; min_fields: number; }; }[]; name: string; status: 'deployed' | 'draft'; type: 'generation'; updated_at: string; last_deployed_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/applications \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; application_id: string; created_at: string; status: 'in_progress' | 'failed' | 'completed'; completed_at?: string; data?: { suggestion: string; title?: string; }; error?: string; updated_at?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/applications/$APPLICATION_ID/jobs \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/applications/jobs/$JOB_ID/retry \\\n    -X POST \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/applications/jobs/$JOB_ID \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/applications/$APPLICATION_ID/graphs \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/chat \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"messages\": [\n            {\n              \"role\": \"user\"\n            }\n          ],\n          \"model\": \"model\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/completions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"model\": \"palmyra-x-003-instruct\",\n          \"prompt\": \"Write me an SEO article about...\"\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; name: string; description?: string; urls?: { status: { status: 'validating' | 'success' | 'error'; error_type?: 'invalid_url' | 'not_searchable' | 'not_found' | 'paywall_or_login_page' | 'unexpected_error'; }; type: 'single_page' | 'sub_pages'; url: string; exclude_urls?: string[]; }[]; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/graphs/$GRAPH_ID \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/graphs/$GRAPH_ID/file \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"file_id\": \"file_id\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/graphs/$GRAPH_ID/file/$FILE_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ answer: string; question: string; sources: { file_id: string; snippet: string; }[]; references?: { files?: { fileId: string; score: number; text: string; cite?: string; page?: number; }[]; web?: { score: number; text: string; title: string; url: string; }[]; }; subqueries?: { answer: string; query: string; sources: object[]; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/graphs/question \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"graph_ids\": [\n            \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n          ],\n          \"question\": \"question\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/files/$FILE_ID \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/files/$FILE_ID/download \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/files/retry \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"file_ids\": [\n            \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/tools/pdf-parser/$FILE_ID \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"format\": \"text\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/tools/web-search \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/translation \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"formality\": true,\n          \"length_control\": true,\n          \"mask_profanity\": true,\n          \"model\": \"palmyra-translate\",\n          \"source_language_code\": \"en\",\n          \"target_language_code\": \"es\",\n          \"text\": \"Hello, world!\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.writer.com/v1/vision \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WRITER_API_KEY\" \\\n    -d '{\n          \"model\": \"palmyra-vision\",\n          \"prompt\": \"Describe the difference between the image {{image_1}} and the image {{image_2}}.\",\n          \"variables\": [\n            {\n              \"file_id\": \"f1234\",\n              \"name\": \"image_1\"\n            },\n            {\n              \"file_id\": \"f9876\",\n              \"name\": \"image_2\"\n            }\n          ]\n        }'"
      }
    }
  }
];
