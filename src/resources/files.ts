...
export class Files extends APIResource {
  ...
  upload(params: FileUploadParams, options?: RequestOptions): APIPromise<File> {
    ...
    return this._client.post('/v1/files', { query: { graphId }, body: content, ...options, headers: buildHeaders([{'Content-Type': 'text/plain', 'Content-Disposition': contentDisposition}, options?.headers]) });
  }
}
