...
import { APIPromise } from 'writer-sdk/core/api-promise';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new Writer({ baseURL: 'http://localhost:5000/custom/path/', apiKey: 'My API Key' });
    ...
    afterEach(() => {
      process.env['WRITER_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new Writer({ baseURL: 'https://example.com', apiKey: 'My API Key' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['WRITER_BASE_URL'] = 'https://example.com/from_env';
      const client = new Writer({ apiKey: 'My API Key' });
  ...
  describe('withOptions', () => {
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Writer({ baseURL: 'http://localhost:5000/', timeout: 1000, apiKey: 'My API Key' });
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new Writer({ apiKey: 'My API Key', timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new Writer({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new Writer({ apiKey: 'My API Key', fetch: testFetch });
